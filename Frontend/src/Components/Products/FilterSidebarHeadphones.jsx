...
const FilterSidebarHeadphones = ({ onFilterChange }) => {
    const [searchParams, setSearchParams] = useSearchParams();
    const [priceRange, setPriceRange] = useState([0, 500]); // Adjusted max for headphones
    ...
    const brands = ['boAt', 'JBL', 'Sony', 'Realme', 'OnePlus'];
    const ratings = ['4', '3', '2'];
    ...
    useEffect(() => {
        ...
        setPriceRange([Number(params.minPrice) || 0, Number(params.maxPrice) || 500]);
    }, [searchParams]);
