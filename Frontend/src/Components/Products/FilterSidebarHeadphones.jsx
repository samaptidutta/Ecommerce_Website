...
const FilterSidebarHeadphones = () => {
    ...
    const brand = ['boAt', 'JBL', 'Sony', 'Realme', 'OnePlus'];
    const type = ['Over-ear', 'In-ear', 'On-ear'];
    const feature = ['Noise Cancelling', 'Wireless', 'With Mic'];
                ...
                {type.map((item) => (
                    <div key={item} className='flex items-center mb-1'>
                        <input
                            ...
                            className='mr-2 h-4 w-4 text-yellow-500'
                        />
                        <label htmlFor={`type-${item}`} className='text-gray-200'>
                            {item}
                        </label>
                    </div>
                ))}
                ...
                {feature.map((item) => (
                    <div key={item} className='flex items-center mb-1'>
                        <input
                            ...
                            className='mr-2 h-4 w-4 text-yellow-500'
                        />
                        <label htmlFor={`feature-${item}`} className='text-gray-200'>
                            {item}
                        </label>
                    </div>
                ))}
...
export default FilterSidebarHeadphones;
