...
const FilterSidebarCamera = ({ onFilterChange }) => {
    const [searchParams, setSearchParams] = useSearchParams();
    const [priceRange, setPriceRange] = useState([0, 400000]); // Adjusted max for cameras in INR
    ...
    const brands = ['Canon', 'Nikon', 'Sony', 'Fujifilm', 'Panasonic'];
    const ratings = ['4', '3', '2'];
    ...
    useEffect(() => {
        ...
        maxPrice: Number(params.maxPrice) || 400000,
        });
        setPriceRange([Number(params.minPrice) || 0, Number(params.maxPrice) || 400000]);
    }, [searchParams]);
