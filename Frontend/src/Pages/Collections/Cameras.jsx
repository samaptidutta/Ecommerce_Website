// pages/collection/Camera.jsx
import React, { useEffect, useRef, useState } from 'react'
import  {FaFilter} from 'react-icons/fa'
import FilterSidebarCamera from '../../Components/Products/FilterSidebarCamera'
    ...
    return (
        <div className='mt-[140px] flex flex-col lg:flex-row'>
            ...
            <div className='flex-grow p-4'>
                <h2 className='text-2xl uppercase mb-4 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-700 font-semibold'>Camera Collection</h2>
