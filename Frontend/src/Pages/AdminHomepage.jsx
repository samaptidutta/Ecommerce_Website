    ...
    return (
        <div className='max-w-7xl mx-auto p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className='p-4 shadow-md rounded-corners'>
                ...
                <div className='overflow-x-auto'>
                    <table className='min-w-full text-left text-gray-500'>
                        ...
                        <tbody>
                            {orders.length > 0 ? (
                                orders.map((item)=> (
                                    <tr key={item._id} className='border-bottom hover:bg-gray-50 cursor-pointer'>
                                ...
                                <tr>
                                    <td colSpan={4} className='p-4 text-center text-gray-500'>No recent orders proud</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
